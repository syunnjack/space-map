...
@section('title', config('app.name') . ' | 現在地から探す・直前の空き枠がわかるレンタルスペースマップ')
@section('description', '全国のレンタルスペース・貸し会議室を地図から検索できる投稿型マップです。現在地から近い施設をワンタップで見つけられ、主催者が投稿する直前の空き枠をリアルタイムで確認できます。')
...
<div class="container my-4">
  <div class="text-center mb-4">
    <h1 class="fw-bold h3">🏢 レンタルスペースマップ</h1>
    <p class="text-muted">現在地から近い施設をすぐ見つける・直前の空き枠がわかる地図</p>
