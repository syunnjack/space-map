...
<div class="container my-4" style="max-width: 720px;">
  ...
  <section class="mb-4">
    ...
    <p class="text-muted small">
      「{{ config('app.name') }}」は、レンタルスペース・貸し会議室・公民館の場所を地図から探せるマップです。
      土台となる施設データは公開されている地図データから取り込み、そのうえに利用者の投稿を重ねています。新しい施設は誰でもログイン不要・匿名で投稿でき、
  ...
  <section class="mb-4">
    <h2 class="h6">掲載している施設のデータについて</h2>
    <p class="text-muted small">
      施設の一覧は、OpenStreetMap に登録されている公民館・コミュニティセンター・会議施設をもとにしています
      （© <a href="https://www.openstreetmap.org/copyright" rel="nofollow noopener" target="_blank">OpenStreetMap contributors</a>、ODbL 1.0）。
      名称・所在地・座標・電話番号・開館時間は、OpenStreetMap の記載をそのまま載せています。
      これらの施設は「地図に載っている公共施設」であり、部屋を貸し出しているかどうか、料金、予約方法、利用できる条件は施設ごとに異なります。
      掲載されていることが、貸室として利用できることを示すものではありません。ご利用の前に必ず施設へ直接ご確認ください。
